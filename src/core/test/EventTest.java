...
public class EventTest
{
	...
	public void testScheduledTimes()
	{
		...
		assertEquals("added duration is calculated incorrectly",test.getDuration(),60*1000);
		...
		assertEquals("added duration should be set to value passed in",test.getDuration(),60*59*1000);
		assertEquals("End time is calculated incorrectly.", test.getEndTime(),c.getTime());
	}
